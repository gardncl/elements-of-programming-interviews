...
class GenerateNonuniformRandomNumbersTest {
    ...
    @Test
    void nonUniformRandomNumberGeneration1() {
    ...
    @Test
    void nonUniformRandomNumberGeneration2() {
    ...
    @Test
    void nonUniformRandomNumberGeneration3() {
        values = Arrays.asList(1, 2, 3, 4, 5);
